...
<template>
  ...
  <div class="svg-container">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <symbol id="svg-git" viewBox="0 0 256 256">
        <path fill="#de4c36"
      ...
      <symbol id="svg-github" viewBox="-1163 1657.697 56.693 56.693">
        <path fill="currentColor"
      ...
      <symbol id="svg-webpack" viewBox="0 0 256 290">
        <path fill="#fff" d="m128 .04830189 128 72.40452831v144.8573588l-128 72.404528-128-72.404528v-144.8573588z"/>
        <path fill="#8ed6fb"
